...
<details>
  <summary>Solution</summary>
	<br>- [x] The query uses an index to determine the order in which to return result documents.
	<br>- [ ] The query uses an index to determine which documents match.
	<br>- [ ] The query returns 251120 documents.
	<br>- [x] The query examines 251120 documents.
	<br>- [ ] The query is a covered query.
</details>