...
[m101j-blog-indexes.zip](https://university.mongodb.com/static/MongoDB_2018_M101J_August/handouts/m101j-blog-indexes.zip)
...
<details>
  <summary>Solution</summary>
	<br>db.posts.createIndex( {date : -1} );
	<br>db.posts.createIndex( {permalink : 1} );
	<br>db.posts.createIndex( {tags : 1, date : -1} );
</details>